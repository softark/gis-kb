...
- メニュー > 設定 > オプション > 座標参照系 と 変換 > 座標参照系 (CRS)
    - プロジェクトの座標参照系
        - 新規プロジェクトが作られたとき
            - 最初のレイヤの CRS を使う
...
少なくともトレーニング・マニュアルをやる間は、新規プロジェクトの座標参照系のデフォルトを「最初のレイヤの CRS を使う」にしておくと良い。

### 2.3. Lesson: Navigating the Map Canvas 地図キャンバスを見て回る

パン（スクロール）、ズームイン、ズームアウトの方法
...
#### 2.4.8 Follow Along: Ordering Symbol Levels シンボル・レベルの順序付け
...
チュートリアルの例で言うと、道路を表す地物について、一つずつ外郭線を描いてから中を塗りつぶすか、
それとも、外郭線をまとめた描いてから中を塗りつぶすか、という違い。

#### 2.4.13. Follow Along: Geometry generator symbology

これも訳しづらい。幾何形状生成 symbology
